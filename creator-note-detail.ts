 ...
 *
 * 来源: opencli/src/clis/xiaohongshu/creator-note-detail.ts
 */
...
async function captureNoteDetailPayload(page: any, noteId: string): Promise<NoteDetailApiPayload | null> {
...
async function captureNoteDetailDomData(page: any): Promise<CreatorNoteDetailDomData | null> {
